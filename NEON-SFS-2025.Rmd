...
macroinvertebrate abundacne and richness.
...
# plot a timesereis of fDOM
fDOM_plot <- fDOM_15min%>%
  ggplot2::ggplot(aes(x=roundDate,y=mean_fDOM))+
  ggplot2::geom_line()+
  ggplot2::labs(title = "Flourescent dissolved organic matter (fDOM) over time",
                y = "fDOM (QSU)",
                x = "Date")
...
# show a plot of the relationship with a linear treadline added
